...
function parseArgs(argv: string[]): CliOptions {
  const opts: CliOptions = {
    ...
    romOffset: DEFAULT_CONFIG.romOffset,
    tableStartBytes: DEFAULT_CONFIG.tableStartBytes,
    slotSize: DEFAULT_CONFIG.slotSize,
